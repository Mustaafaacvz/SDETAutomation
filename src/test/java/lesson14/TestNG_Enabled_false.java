...
public class TestNG_Enabled_false {
    ...
    static WebDriver driver; // WebDriver instance for controlling the browser
    ...
    // Test 2: Verify error message is shown for invalid username with valid password
    @Test(priority = 3)
    ...
    // Test 3: Verify error message is shown for valid username with invalid password
    @Test(priority = 1, enabled = false) // This test is disabled and will not run
